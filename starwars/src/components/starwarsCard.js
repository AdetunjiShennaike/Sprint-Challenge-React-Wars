...
function CharacterCard(props) {
  return (
    <div className='card-container'>
      <div className={`card card-item-front display ${props.card.check ? 'display' : ''}`} onClick={() => props.toggle(props.card.url)}>
      ...
      <div className={`card card-item-back ${props.card.check ? 'display' : ''}`} onClick={() => props.toggle(props.card.url)}>
        {console.log(props.card.check)}
